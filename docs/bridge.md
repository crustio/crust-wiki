...
Please note that the transaction is automatically executed through a smart contract, and 1CRU is charged as a transaction fee. Please wait patiently as there might be a certain delay. You can click the link on the right side to check the transaction status.
