...
- Use the following default W3Auth Header or Get a new IPFS W3Auth Header by [buildIPFSWeb3AuthGW](https://wiki.crust.network/docs/zh-CN/buildIPFSWeb3AuthGW#usage)
